...
fn main() {
    ...
    let matches = App::new("kDump Utility")
                            ...
                            .arg(Arg::with_name("disassemble")
                                .help("Disassembles the contents of the entire file")
                                .short("D")
                                .long("disassemble"))
                            ...
                            .arg(Arg::with_name("section_headers")
                                .help("Displays the section headers of each section in the object file.")
                                .short("h")
                            ...
                            .arg(Arg::with_name("stabs")
                                .help("Displays the contents of all of the string tables in the object file.")
                                .short("S")
                                .long("stabs"))
                            .arg(Arg::with_name("syms")
                                .help("Displays the contenst of all symbol tables in the object file.")
                                .short("t")
                                .long("syms"))
